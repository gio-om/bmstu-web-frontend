...
import {T_FlightsFilters} from "modules/types.ts";
...
const FlightsPage = () => {
    ...
    const applyFilters = async (e) => {
        ...
        const filters:T_FlightsFilters = {
            status: status,
    ...
    return (
        <Container>
            ...
            {flights.length ? <FlightsTable flights={flights}/> : <h3 className="text-center mt-5">Полеты не найдены</h3>}  
        </Container>
    )
};
